...
client = pymongo.MongoClient(
    "mongodb+srv://carlen:XmHyP5culdETPnwG@cluster0.abpqf.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", ssl=True, ssl_cert_reqs='CERT_NONE')
db = client.test
...
input_shape = 224
cars = ['Accord', 'Alphard', 'Altis', 'BT-50',
        'Brio', 'C-HR', 'CX-8', 'Mazda2', 'Other', 'Vios']
